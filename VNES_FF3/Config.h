...
public:
	...
	void	Default() {
		...
		nShortCut[ 34] = DIK_F8;		// State Slot +
		nShortCut[ 35] = DIK_F6;		// State Slot -
		nShortCut[ 36] = DIK_0;		// State Slot
		nShortCut[ 37] = DIK_1;		// State Slot
		nShortCut[ 38] = DIK_2;		// State Slot
		nShortCut[ 39] = DIK_3;		// State Slot
		nShortCut[ 40] = DIK_4;		// State Slot
		nShortCut[ 41] = DIK_5;		// State Slot
		nShortCut[ 42] = DIK_6;		// State Slot
		nShortCut[ 43] = DIK_7;		// State Slot
		nShortCut[ 44] = DIK_8;		// State Slot
		nShortCut[ 45] = DIK_9;		// State Slot
		...
		// Movie controls
		nShortCut[ 56] = DIK_P+K_CTRL;		// Movie Play
		...
		// Screen controls
		nShortCut[ 64] = DIK_F9;		// Zoom x1
		nShortCut[ 65] = 0;		// Zoom x2
		nShortCut[ 66] = 0;		// Zoom x3
		nShortCut[ 67] = 0;		// Zoom x4
		nShortCut[ 68] = DIK_F10;		// Fullscreen

		// Sound controls
		nShortCut[ 72] = DIK_F11;	// Mute Master
...
public:
	...
	void	DefaultController1() {
		...
		nButton[0][ 8] = DIK_F; // SELECT
		nButton[0][ 9] = DIK_H; // START
		nButton[0][10] = 0;	// EX C
		nButton[0][11] = 0;	// EX D
		nButton[0][12] = 0;	// EX E
		nButton[0][13] = 0;	// EX F
	...
	void	DefaultController2() {
		nButton[1][ 0] = DIK_UP;
		nButton[1][ 1] = DIK_DOWN;
		nButton[1][ 2] = DIK_LEFT;
		nButton[1][ 3] = DIK_RIGHT;
		nButton[1][ 4] = DIK_DECIMAL;	// A
		nButton[1][ 5] = DIK_NUMPAD0;	// B
		nButton[1][ 6] = 0;	// A Rapid
		nButton[1][ 7] = 0;	// B Rapid
		nButton[1][ 8] = 0;	// SELECT
		nButton[1][ 9] = 0;	// START
		nButton[1][10] = DIK_NUMPAD1;	// Mic
		nButton[1][11] = 0;	// EX D
		nButton[1][12] = 0;	// EX E
		nButton[1][13] = 0;	// EX F
		nButton[1][14] = 0;	// EX G
